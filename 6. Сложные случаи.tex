...
\hypo{(\psi \wedge \chi) \to C^\psi_G \varphi}
...
$\chi \to E_G (\psi \to \bigwedge \{\neg \underline{Y} \mid Y \in \overline{S} \}) \Leftrightarrow $
\end{block}

Доказательство.
\begin{enumerate}
\item $\forall i \in G$: $\underline{X} \to  K_i (\psi \to \bigwedge \{\neg \underline{Y} \mid Y \in \overline{S} \})$ 	
\item $\forall i \in G$: $\underline{X} \to  K_i (\bigwedge \{\psi \to \neg \underline{Y} \mid Y \in \overline{S} \})$ 
\item $\forall i \in G$: $\underline{X} \to  \bigwedge \{K_i (\psi \to \neg \underline{Y}) \mid Y \in \overline{S} \}$
\item $\forall i \in G \; \forall Y \in \overline{S}$: $\underline{X} \to K_i (\psi \to \neg \underline{Y}) $
\end{enumerate}
